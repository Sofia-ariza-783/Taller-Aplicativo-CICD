...
/**
 * REST controller for managing Chef entities.
 * Provides endpoints for creating, retrieving, and deleting chefs.
 */
...
public class chefController {
     ...
     * @return ResponseEntity containing the created chef and HTTP status 201 if successful,
     ...
     * @return ResponseEntity containing the chef if found (HTTP 200),
     *         or HTTP status 404 if no chef with the given ID exists
     */
    @GetMapping("/{id}")
     ...
     *         or HTTP status 404 (Not Found) if the chef doesn't exist
     */
    @DeleteMapping("/{id}")
