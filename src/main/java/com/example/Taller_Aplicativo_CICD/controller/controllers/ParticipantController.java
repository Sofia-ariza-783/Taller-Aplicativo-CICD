 ...
 * Provides endpoints for creating, retrieving, and deleting participants.
 */
...
public class ParticipantController {
     ...
     * @return ResponseEntity containing the created participant and HTTP status 201 if successful,
     ...
     * @return ResponseEntity containing the participant if found (HTTP 200),
     *         or HTTP status 404 if no participant with the given name exists
     */
     ...
     * @return ResponseEntity containing the participant if found (HTTP 200),
     *         or HTTP status 404 if no participant with the given ID exists
     */
    @GetMapping("/id/{id}")
     ...
     *         or HTTP status 404 (Not Found) if the participant doesn't exist
     */
    @DeleteMapping("/{id}")
