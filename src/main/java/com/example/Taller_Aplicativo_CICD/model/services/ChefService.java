...
/**
 * Service class for managing Chef entities. Handles business logic for chef-related operations
...
public class ChefService {
   ...
   * @throws RuntimeException if a chef with the same name already exists or if there's an error
   *     during creation
   */
