...
/**
 * Service class for managing Viewer entities.
 * Handles business logic for viewer-related operations including creation, retrieval, and deletion.
 */
@Service
@AllArgsConstructor
public class ViewerService {
     ...
     * @throws RuntimeException if a viewer with the same name already exists or if there's an error during creation
     */
