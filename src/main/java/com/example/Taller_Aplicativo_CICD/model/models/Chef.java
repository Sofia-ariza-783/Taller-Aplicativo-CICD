...
/**
 * Represents a Chef entity in the system. This class extends the Cooker class and is used to model
 * users with chef privileges. Chefs have the ability to create and manage recipes in the system.
 */
@Document(collection = "Chefs")
public class Chef extends Cooker {

  /**
   * Constructs a new Chef with the specified ID and full name. The role is automatically set to
   * CHEF.
   *
