...
/**
 * Represents a Viewer entity in the system. This class extends the Cooker class and is used to
 * model users with viewer privileges. Viewers have read-only access to the system's resources.
 */
@Document(collection = "Viewers")
public class Viewer extends Cooker {

  /**
   * Constructs a new Viewer with the specified ID and full name. The role is automatically set to
   * VIEWER.
   *
