...
class ParticipantServiceTest {
  ...
  void createParticipant_WhenParticipantExists_ShouldThrowException() {
    ...
    // Act & Assert
    assertThrows(
        RuntimeException.class, () -> participantService.createParticipant(testParticipantDto));
  ...
  void getParticipantByName_WhenNotFound_ShouldThrowException() {
    ...
    // Act & Assert
    assertThrows(
        RuntimeException.class, () -> participantService.getParticipantByName("nonexistent"));
  }
  ...
  void getParticipantById_WhenNotFound_ShouldThrowException() {
    ...
    // Act & Assert
    assertThrows(
        RuntimeException.class, () -> participantService.getParticipantById("nonexistent"));
  }
