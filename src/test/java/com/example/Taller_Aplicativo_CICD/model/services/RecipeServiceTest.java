...
class RecipeServiceTest {
    ...
    void getRecipeByParticipant_WhenParticipantNotFound_ShouldThrowException() {
        ...
        assertThrows(RuntimeException.class, 
            () -> recipeService.getRecipeByParticipant("Nonexistent"));
    }
    ...
    void getRecipeByParticipant_WhenRecipeNotFound_ShouldThrowException() {
        ...
        // Act & Assert
        assertThrows(RuntimeException.class, 
            () -> recipeService.getRecipeByParticipant("Chef John"));
    }
    ...
    void getRecipeByAutor_WhenAuthorNotFound_ShouldThrowException() {
        ...
        // Act & Assert
        assertThrows(RuntimeException.class, 
            () -> recipeService.getRecipeByAutor("Nonexistent"));
    }
    ...
    void getRecipeByNumber_WhenNotFound_ShouldThrowException() {
        ...
        // Act & Assert
        assertThrows(RuntimeException.class, 
            () -> recipeService.getRecipeByNumber(999));
    }
    ...
    void updateRecipe_WhenRecipeNotFound_ShouldThrowException() {
        ...
        RecipeDto updateDto = new RecipeDto("Updated Chef", "new1, new2", "New Step 1; New Step 2");

        // Act & Assert
        assertThrows(RuntimeException.class, 
            () -> recipeService.updateRecipe("nonexistent", updateDto));
    }
