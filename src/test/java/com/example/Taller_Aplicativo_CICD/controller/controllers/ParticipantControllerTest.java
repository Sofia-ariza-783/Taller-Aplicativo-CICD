...
class ParticipantControllerTest {
  ...
  void createParticipant_ShouldReturnCreated() {
    ...
    ResponseEntity<Participant> response =
        participantController.createParticipant(testParticipantDto);
  ...
  void getParticipantByName_ShouldReturnParticipant() {
    ...
    // Act
    ResponseEntity<Participant> response =
        participantController.getParticipantByName("Test Participant");
  ...
  void getParticipantByName_WhenNotFound_ShouldReturnNotFound() {
    ...
    // Act
    ResponseEntity<Participant> response =
        participantController.getParticipantByName("Nonexistent");
